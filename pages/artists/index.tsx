  ...
  return (
    <Layout>
      <div className="topic__page">
        <div className="topic__header flex flex-col gap-4 justify-center bg-[url('/images/artistsHeader.png')] bg-cover bg-bottom w-[100%] max-h-[204px] h-[204px] md:pr-[0px] lg:pl-[0px] lg:pr-[0px] md:pt-1% md:pb-1% items-center">
        ...
        <div className="topic__body md:pl-[10%] md:pr-[10%] lg:pr-[15%] lg:pl-[15%] flex flex-col justify-center items-center">
          ...
          <div className="recents flex flex-col justify-center items-center w-[100vw] pl-[21px]">
            ...
            <div className="flex lg:justify-center w-[100vw] items-start justify-start">
              <SliderNew />
            </div>
          </div>
          <div className="recents flex flex-col justify-center items-center w-[100vw] pl-[21px]">
          ...
          <div className="recents flex flex-col justify-center items-center w-[100vw] pl-[21px]">
            ...
            <div className="flex lg:justify-center w-[100vw] items-start justify-start pb-[95px]">
              <SliderNew />
            </div>
          </div>
        </div>
...
ArtistsPage.getLayout = function (page: ReactElement) {
  return (
    <Layout title="Artists | Para Cuando?" description="Artist and concerts">
