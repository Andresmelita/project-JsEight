...
export default function TournamentsPage() {
  ...
  return (
    <div className="topic__page">
      <div className="topic__header flex flex-col gap-4 justify-center bg-[url('/images/tournamentsHeader.png')] bg-cover bg-bottom w-[100%] max-h-[204px] h-[204px] md:pr-[0px] lg:pl-[0px] lg:pr-[0px] md:pt-1% md:pb-1% items-center">
