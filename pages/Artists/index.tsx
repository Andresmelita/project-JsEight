...
export default function artistsPage(){
  return (
    <div className="topic__page">
      <div className="topic__header p-4 flex flex-col gap-4 justify-center bg-[url('/images/artistsHeader.png')] bg-cover bg-center w-[100%] max-h-[204px] h-[204px] md:pl-[10%] md:pr-[10%] lg:pl-[15%] lg:pr-[15%] md:pt-1% md:pb-1%">
        <div className="header__links">
          <span className='h500-normal-16px text-[#fff]'><Link href="/">Home </Link> / Artists</span>
        </div>
