...
export default function eventId(){
  return (
    <div className="event__details">
      <div className="details p-4 flex flex-col gap-3 h500-normal-16px">
        ...
        <div className="HeaderImg bg-[url('https://los40es00.epimg.net/los40/imagenes/2017/02/06/musica/1486367147_194336_1486369812_noticia_normal.jpg')] bg-cover bg-center h-60 z-0 w-[100%]"></div>
        <div className="vote__button">
          <button className='w-full p-4 mt-5 bg-[#1B4DB1] rounded-[23px] text-[#fff] l600-normal-16px'>Vote</button>
        </div>
      </div>
      <div className="interests p-4 bg-[#F8F7FA] w-100vh h-[228px] flex flex-col gap-3">
        ...
        <div className="interests__show flex gap-2">
          <div className="interest__item h400-normal-13px text-[#A7A6A7] border border-[#A7A6A7] rounded-[23px] w-fit h-[45px] flex justify-center items-center">
        ...
        <div className="show__more h400-normal-16px text-[#1B4DB1]">
          <p>Ver todos los intereses</p>
        </div>
      </div>
      <div className="recents p-4 flex flex-col gap-3">
