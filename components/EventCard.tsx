...
const EventCard = () => {
  return (
    <div className="EventCard w-80 rounded-3xl m-3 relative z-10 shadow-card-box">
        ...
        <div className="HeaderImg bg-[url('https://los40es00.epimg.net/los40/imagenes/2017/02/06/musica/1486367147_194336_1486369812_noticia_normal.jpg')] bg-cover bg-center h-60 z-0 rounded-t-3xl ">
        </div>
        <div className="BodyContent m-8 mt-4 h-52 flex flex-col gap-4">
            <div className="content__event h-26 flex flex-col gap-2">
                ...
                <div className="content__description h400-medium-15px text-[#6E6A6C]">
                    <p>El concierto con la temática de Lady gaga en Las Vegas. El concierto con la temática de Lady gaga en Las Vegas.El concierto con la temática.</p>
                </div>
            </div>
